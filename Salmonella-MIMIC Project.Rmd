...
Greetings!  
   ...
   Also, I originally intended this to be more blog post-esque. Unfortunately, my inner nerd took over and turned it into more of a manuscript. I still left in my code, including some of the comments for when things went wonky, but overall it's a pretty dry read. My apologies.  
...
```
Cases and controls are indeed significantly similar, so differentiating between case status may be difficult.   
